...
module SimpleCalorimeter ECal {
  ...
  set ResolutionFormula {          (eta <= -2.3 && eta>-3.5)                          * sqrt(energy^2*0.01^2 + energy*0.020^2 )+ \
                 		   (eta <= -1.5 && eta>-2.3 )                         * sqrt(energy^2*0.02^2 + energy*0.025^2 )+ \
				   (eta <= 1.2  && eta> -1.5 )                        * sqrt(energy^2*0.01^2 + energy*0.055^2 )+ \
				   (eta <= 3.5  &&  eta>1.2 )                         * sqrt(energy^2*0.02^2 + energy*0.100^2 )}
...
module SimpleCalorimeter HCal {
  ...
  set pi [expr {acos(-1)}]
    ...
    foreach eta {-3.5 -2.95880652 -2.68264484 -2.46773612 -2.29224349 -2.14432155 -2.01681569 -1.90506801 -1.80587261 -1.71692581 -1.63651428 -1.56332731 -1.49633825 -1.43472677 -1.37782606 -1.325086   -1.27604684 -1.23031998 -1.18757364 -1.14752205 -1.10991713 -1.07454199 -1.04120583 -1.00} {
	add EtaPhiBins $eta $PhiBins
    }
    
    foreach eta {1.0 1.04 1.075 1.1099 1.14752205 1.18757364 1.23031998 1.27604684 1.325086 1.37782606 1.43472677 1.49633825 1.56332731 1.63651428 1.71692581 1.80587261 1.90506801 2.01681569 2.14432155 2.29224349 2.46773612 2.68264484 2.95880652 3.5} {
	add EtaPhiBins $eta $PhiBins
    }
  ...
  set ResolutionFormula {    (eta <= -1.0 && eta>-3.5)                       * sqrt(energy^2*0.05^2 + energy*0.70^2)+
                             (eta <= 1.0 && eta>-1.0 )                       * sqrt(energy^2*0.37^2 )+
                             (eta <= 3.5 && eta>1.0 )                        * sqrt(energy^2*0.06^2 + energy*0.40^2)
  }
